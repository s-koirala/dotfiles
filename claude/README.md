...
Scope spans finance + financial markets + population science + public health + statistics + biostatistics + app development — see the top-level [README](../README.md) for details and rule-globs.
